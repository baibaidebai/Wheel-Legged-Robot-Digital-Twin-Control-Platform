...
def generate_launch_description():
    ...
    # URDF文件路径
    urdf_file = PathJoinSubstitution([pkg_wheel_legged_control, 'urdf', 'wheel_legged_robot.urdf'])
    
    # 读取URDF文件内容
    with open(os.path.join(pkg_wheel_legged_control, 'urdf', 'wheel_legged_robot.urdf'), 'r') as file:
